...
file7 = open('Proxima_lower_mantle_1B.txt')
file8 = open('Proxima_lower_mantle_1B.txt')
file9 = open('Proxima_lower_mantle_1B.txt')
file10 = open('Proxima_lower_mantle_1B.txt')
file11 = open('Proxima_lower_mantle_1B.txt')
file12 = open('Proxima_lower_mantle_1B.txt')
...
file19 = open('Proxima_lower_mantle_1B.txt')
file20 = open('Proxima_lower_mantle_1B.txt')
file21 = open('Proxima_lower_mantle_1B.txt')
...
Rt = np.concatenate((R1, R2, R3, R7), axis=0)
Pt = np.concatenate((P1, P2, P3, P7), axis=0)
Tt = np.concatenate((T1, T2, T3, T7), axis=0)
gt = np.concatenate((g1, g2, g3, g7), axis=0)
dt = np.concatenate((d1, d2, d3, d4), axis=0)


import csv
with open('Density_incomplete.txt', 'w+') as x:
    
    writer = csv.writer(x, delimiter='\t')
    writer.writerows(zip(Rt, dt))

with open('Temp_incomplete.txt', 'w+') as x:
