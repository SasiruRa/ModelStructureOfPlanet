...
p_ini = 171.2452473822577
T_ini = 2007.0196351293027
m_ini =  1.2893491350525289e+24
density = 6092.059444938335
g_ini = 9.942383504049134
r_ini = 2941.90000099842
q_ini = 0.0008749056570568497
...
import csv
with open('Proxima_lower_mantle_1.txt', 'w+') as x:
    
    writer = csv.writer(x, delimiter='\t')
    writer.writerows(zip(pressure, Temperature, radius))

with open('Proxima_lower_mantle_2.txt', 'w+') as x:
    
    writer = csv.writer(x, delimiter='\t')
    writer.writerows(zip(mass, gravity, radius))

with open('Proxima_lower_mantle_3.txt', 'w+') as x:
